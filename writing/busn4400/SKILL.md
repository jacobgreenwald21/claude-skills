---
trigger: "do it again, another Slack comment, next blog reaction, BUSN 4400, busn4400, class blog, slack post for class, blog post for class, reaction post, weekly reaction, write a slack post, write a blog post, write a blog comment, write a slack comment, draft a slack post, draft a blog post, draft a blog comment, draft a slack comment, class discussion post, peer comment for class"
---
