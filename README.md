...
|---|---|---|
| commander | "run Commander" | Session auditor — captures misfires, audits full skill portfolio, reads and clears open-items.md, updates MEMORY.md, backs up skills directory, and runs end-of-session chain. |
